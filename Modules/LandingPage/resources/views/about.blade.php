          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="service-box">
              ...
              <div class="services-list nav flex-column" id="serviceTab" role="tablist">
                ...
                role="tab">
                  <i class="bi bi-arrow-right-circle"></i><span>{{$item->title}}</span>
                </a>
                @endforeach

                {{-- <!-- Tab History -->
                <a href="#" class="nav-link" id="sejarah-tab" data-bs-toggle="tab" data-bs-target="#sejarah" role="tab">
                  <i class="bi bi-arrow-right-circle"></i><span>Sejarah</span>
                </a>

                <!-- Tab Vision & Mission -->
                <a href="#" class="nav-link" id="visimisi-tab" data-bs-toggle="tab" data-bs-target="#visimisi" role="tab">
                  <i class="bi bi-arrow-right-circle"></i><span>Visi & Misi</span>
                </a> --}}
              </div>
            </div>
            ...
            <div class="service-box">
              ...
              <div class="download-catalog">
                ...
                @if (!empty($item->pdf))
                  <a href="#" class="open-doc" data-doc="{{ asset('gallery/' . $item->pdf) }}" data-title="{{ $item->pdf }}">
                    <i class="bi bi-filetype-pdf"></i><span>{{ $item->pdf }}</span>
                  </a>
                @endif
              @endforeach
                {{-- <a href="#"><i class="bi bi-filetype-pdf"></i><span>AD/ART SPPAS</span></a>
                <a href="#"><i class="bi bi-filetype-pdf"></i><span>Perjanjian Kerja Bersama</span></a> --}}
              </div>
          ...
          <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="tab-content" id="serviceTabContent">
              ...
              <div class="tab-pane fade show {{ $index == 0 ? 'active' : '' }}" id="{{$item->slug}}" role="tabpanel">
                <img src="{{ asset('gallery/'.$item->photo)}}" alt="Serikat Pekerja" class="img-fluid services-img">
               {!!$item->description!!}
              </div>
              @endforeach
