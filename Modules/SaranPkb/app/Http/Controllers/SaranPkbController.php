...
namespace Modules\SaranPkb\Http\Controllers;
...
class SaranPkbController extends Controller
{
    public function index()
    {
      ...
      if ($ksp == 'Ketua Sp' || ($rolepermission && in_array($rolepermission->name, $allowedRoles))) {
          return view('saranpkb::admin.index');
        }
    ...
    {
          return view('saranpkb::anggota.index');
    ...
    public function detail_admin($id)
    {
        ...
        return view('saranpkb::admin.detail', compact('laporan', 'detail_laporan'));
    }
      ...
      public function detail_anggota($id)
    {
        $laporan = DB::table('pelaporan')->find(Crypt::decrypt($id));
        $detail_laporan = DB::table('detail_pelaporan')->where('pelaporan_id', Crypt::decrypt($id))->get();
        return view('saranpkb::anggota.detail', compact('laporan', 'detail_laporan'));
    }
  ...
  public function ajax_data_upload(Request $request, $id)
    ...
    {
        return CrudSaranPkbController::show($request);
    }

      public function show_anggota(Request $request)
    {
        return CrudSaranPkbAnggotaController::show($request);
    }
    /**
    ...
    {
        return CrudSaranPkbAnggotaController::update_upload_tambahan($request);
    }
    ...
    public function update(Request $request) {
        return CrudSaranPkbController::update($request);
    }

        public function store(Request $request) {
        return CrudSaranPkbAnggotaController::store($request);
    }
