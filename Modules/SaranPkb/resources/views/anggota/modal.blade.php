                      ...
                      <input type="hidden" name="uuid" id="uuid">
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <select name="jenis_pelaporan" class="form-select" id="jenis_pelaporan">
                                    ...
                                    <option value="Karir dan promosi">Karir dan promosi</option>
                                    <option value="Benefit dan kesehteraan">⁠Benefit dan kesehteraan</option>
                                    <option value="Keselamatan, keamanan dan alat kerja">Keselamatan, keamanan dan alat kerja</option>
                                    <option value="Tindakan disiplin">Tindakan disiplin</option>
